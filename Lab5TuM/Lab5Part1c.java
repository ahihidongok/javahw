...
public class Lab5Part1c {
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        //File file = new File("/Users/maitu/Desktop/LabCSE/Lab5TuM/Lab5Output.txt"); 
        ...
        while(!eva)
        {
         ...
         try
        {
         PrintWriter pw = new PrintWriter ("/Users/maitu/Desktop/LabCSE/Lab5TuM/Lab5Output.txt");
        String inString ="";
    ...
    System.out.println("\nRegular titles");
    titleFilePrint(pw,titles,counter-1);
   
    changeTitles(titles,titles.length);
    System.out.println("\nBefore sort titles\n");
    printTitles(titles,counter-1);
    titleFilePrint(pw,titles,counter-1);
    ...
    pw.close();
        ...
        {
            System.out.println("Cannot connect printwriter to file");         
        } 
...
for ( int i=0;i<80;i++)
{
    ...
    public static void titleFilePrint (PrintWriter PW, String[] titles, int count)
    {   PW.println("\nArray content\n--------------------\n");
    ...
    public static void changeTitles (String[]titles, int counter)
    {   
        String temp1 = "";
